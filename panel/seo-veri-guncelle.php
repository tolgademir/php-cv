...
<head>
    ...
    <ul>
        ...
        <li><a class="active" href="./seo-veri-guncelle.php">Seo Veri Güncelleme</a></li>
        <li><a class="" href="./seo-veri-ekle.php">Seo Veri Ekleme</a></li>
                ...
                <div class="col-md-7 col-lg-5">
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <form action="islemler/data-update.php" method="POST" enctype="multipart/form-data" class="login-form">
                            ...
                            <br>
                            <div class="form-group">
                                <button type="submit" class="form-control btn btn-primary rounded submit px-3" name="seo">Kaydet</button>
                            </div>
