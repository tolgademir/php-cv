...
<head>
    ...
    <ul>
        ...
        <li><a class="" href="./seo-veri-guncelle.php">Seo Veri Güncelleme</a></li>
        <li><a class="active" href="./seo-veri-ekle.php">Seo Veri Ekleme</a></li>
                        ...
                        <form action="islemler/data-update.php" method="POST" enctype="multipart/form-data" class="login-form">
                            ...
                            <div class="form-group">
                                <button type="submit" class="form-control btn btn-primary rounded submit px-3"
                                    name="seoveriekle">Kaydet</button>
                            </div>
